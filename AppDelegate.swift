...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        if AppDelegate.wifiCommunicationSingleton != nil && disconnectionDetection < 1 {
            if AppDelegate.isFirstLayer {
                ...
                AppDelegate.wifiCommunicationSingleton?.multipeerCommunication.sendDisconnectionSignal()
            }
        }
    }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        AppDelegate.wifiCommunicationSingleton?.multipeerCommunication.stopAdvertisingAndBrowsing()
    }
